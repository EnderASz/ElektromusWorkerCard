ERRORS = {
    'INVALID_VALUE_PASSWORD_ERROR': "Wprowadzony kod identyfikacyjny jest nie poprawny, proszę spróbować ponownie.",
    'INVALID_VALUE_USERNAME_ERROR': "Wprowadzona nazwa pracownika jest niepoprawna, spróbuj ponownie.",
